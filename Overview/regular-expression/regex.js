...
console.log(re2.test("hello world hello"));
...
/[^a-z]/.test("a"); // false | [^a-z] là kp nằm trong khoảng a-> z
...
console.log(str1.match(/\d\d\d\d/)[0]); //2021
console.log(str1.match(/\d{4}/)[0]); //2021
console.log(str1.match(/\d{4,6}/)[0]); //202122
// +: Lấy 1 hoặc nhiều kí tự thoả điều kiện
console.log(str1.match(/\d+/)[0]); //202122243564645645
...
/\*/.test("*");
// \b 
"my name is tinh".match(/\btinh/g); //["tinh"]
// \B
"my name istinh".match(/\Btinh/g);
// 9.
const str4 = "hello welcome hello to my hello";
console.log(str4.replace("hello", "tinh")); // tinh welcome hello to my hello
// string.replace(regex, value);
console.log(str4.replace(/hello/g, "tinh"))
