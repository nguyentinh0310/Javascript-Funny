...
const pets4 = pets.splice(0, 2, "dinasour", "pig", false, 100);
// ["dinasour", "pig", "bird", "dragon"];
console.log(pets);
...
const findYourNumber = numbers.find((element) => element > 1000);
...
// foreach ko return đc, map return đc
// map() trả ra mảng mới dựa vào mảng ban đầu
// foreach ko return đc chạy mãi, ko cách dừng foreach
